...
class User():
    ...
    def password(self, pwd):
        ...
        if pwd is None or type(pwd) is not str:
            """
            Changed the self._password to self.__password:
            Enables the correct assignment of the hashed password
    ...
    def is_valid_password(self, pwd):
        ...
        if self.__password is None:
            return False
        """
        Changed hexdigest().upper() to hexdigest().lower to ensure consistent comparison
        """
